...
{col.LIGHTYELLOW_EX}                        {col.LIGHTYELLOW_EX}A tool for reseting or destroying user accounts.                 
{col.LIGHTYELLOW_EX}                        {col.LIGHTYELLOW_EX}Bane Account Nuker By Ex                             
{col.LIGHTYELLOW_EX}                        {col.LIGHTYELLOW_EX}https://discord.gg/Z8EYQa5                                                                            
{col.LIGHTYELLOW_EX}                        {col.LIGHTYELLOW_EX}{s}Options:                                                                
{col.LIGHTYELLOW_EX}                        {col.LIGHTYELLOW_EX}{s}-------------------------------------                                   
{col.LIGHTYELLOW_EX}                        {col.LIGHTYELLOW_EX}bane - Completely destroys the account               
{col.LIGHTYELLOW_EX}                        {col.LIGHTYELLOW_EX}disable - Disables the account (phone lock)                                     
{col.LIGHTYELLOW_EX}                        {col.LIGHTYELLOW_EX}reset - Deletes all the users guilds                               
{col.LIGHTYELLOW_EX}                        {col.LIGHTYELLOW_EX}remotenuke - remotely nukes a guild if user has admin on it      
{col.LIGHTYELLOW_EX}                        {col.LIGHTYELLOW_EX}-------------------------------------                            
{col.LIGHTYELLOW_EX}                        {col.LIGHTYELLOW_EX}userinfo - Fetches the users friends                           
{col.LIGHTYELLOW_EX}                        {col.LIGHTYELLOW_EX}friendpurge - deletes all friends                                    
""")
##################SETTINGS###################
token = ""#token, if left empty will become an input
bane = False #banes account
guildname = "Ex fucked u" #guildname for bane
##################SETTINGS################### 
if bane == True:
    print(st.BRIGHT+col.RED+f"Ex account fucker is enabled.") 
if not token:
    token = input("Token: ")
